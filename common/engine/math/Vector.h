...
public:
	...
	float distanceFromSq(const Vector2&) const;
...
inline float Vector2::distanceFrom(const Vector2& v) const
{
	return Vector2(X - v.X, Y - v.Y).length(); 
}

inline float Vector2::distanceFromSq(const Vector2& v) const
{
...
public:
	...
	float length() const;
	float lengthSq() const;
	float distanceFrom(const Vector3&) const;
	float distanceFromSq(const Vector3&) const;
...
inline float Vector3::distanceFrom(const Vector3& v) const
{
	return Vector3(X - v.X, Y - v.Y, Z - v.Z).length();
}

inline float Vector3::distanceFromSq(const Vector3& v) const
{
...
public:
	...
	float length() const;
	float lengthSq() const;
	float distanceFrom(const Vector4&) const;
	float distanceFromSq(const Vector4&) const;
...
inline float Vector4::distanceFrom(const Vector4& v) const
{
	return Vector4(X - v.X, Y - v.Y, Z - v.Z, W - v.W).length();
}

inline float Vector4::distanceFromSq(const Vector4& v) const
{
...
public:
	Vector5();
	Vector5(float, float, float, float, float);

public:
	void set(float, float, float, float, float);
};

inline Vector5::Vector5()
{
}

inline Vector5::Vector5(float x, float y, float z, float w,float p)
	: X(x), Y(y), Z(z), W(w),P(p)
{
}


inline void Vector5::set(float x, float y, float z, float w,float p)
{
	X = x;
	Y = y;
	Z = z;
